		...
		parseColourMetaDirective: function ( lineParser ) {
			...
			switch ( finishType ) {
				...
				case LDrawLoader.FINISH_TYPE_CHROME:
					...
					material = new THREE.MeshStandardMaterial( { color: colour, roughness: 0, metalness: 0.3 } );
					break;
				...
				case LDrawLoader.FINISH_TYPE_MATTE_METALLIC:
					...
					material = new THREE.MeshStandardMaterial( { color: colour, roughness: 0.8, metalness: 0.1 } );
					break;

				case LDrawLoader.FINISH_TYPE_METAL:

					// Average metal finish
					material = new THREE.MeshStandardMaterial( { color: colour, roughness: 0.2, metalness: 0.2 } );
					break;
